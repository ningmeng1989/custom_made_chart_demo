...
.value('taOptions',  {
	toolbar: [
		...
		['bold', 'italics', 'underline','blockFormat','fontName', 'fontColor','fontSize', 'strikeThrough', 'ul', 'ol', 'redo', 'undo', 'clear'],
...
.run(['taRegisterTool', '$window', 'taTranslations', 'taSelection', function(taRegisterTool, $window, taTranslations, taSelection){
	...
	angular.forEach(['h1','h2','h3','h4','h5','h6'], function(h){
        ...
        taRegisterTool('fontColor', {
            display: "<button type='button' colorpicker colorpicker-text-editor='true' colorpicker-parent='true' class='btn btn-default font-color' ng-disabled='showHtml()' ng-init-'fontColor=\"#000\"' ng-model='fontColor'><i class='fa fa-magic'></i></button>",
        ...
        taRegisterTool('fontName', {
            //display: "<span class='bar-btn-dropdown' style='padding: 0px'>" +
            //"<button class='btn btn-default dropdown-toggle' text-dropdown-toggle type='button' ng-disabled='showHtml()'><span>{{active}} </span><i class='fa fa-caret-down'></button>" +
            ...
            display: "<span class='bar-btn-dropdown' style='padding: 0px'>" +
            "<button class='btn btn-default dropdown-toggle' text-dropdown-toggle type='button' ng-disabled='showHtml()'><i class='fa fa-font'></i><i class='fa fa-caret-down'></i></button>" +
            "<ul class='dropdown-menu' style='max-height: 180px;overflow-y: auto'><li ng-repeat='o in options'><button class='checked-dropdown' style='font-family: {{o.css}}' type='button' ng-click='action(o.css)'><i ng-if='o.active' class='fa fa-check'></i> {{o.name}}</button></li></ul>" +
            "</span>",
        ...
        taRegisterTool('fontSize', {
            display: "<span class='bar-btn-dropdown' style='padding: 0px'>" +
            "<button class='btn btn-default dropdown-toggle' text-dropdown-toggle type='button' ng-disabled='showHtml()'><i class='fa fa-text-height'> </i><i class='fa fa-caret-down'></i></button>" +
            ...
            action: function(size) {
                if (size !== '' && typeof(size) != 'object') {
                    ...
                    //}
                    console.log('fontSize Command' + size);
                    return this.$editor().wrapSelection('fontSize', size);
                }
            },
            options: [
                {name: '小', css: 'x-small', value: '2'},
                {name: '普通', css: 'small', value: '3'},
                {name: '大', css: 'medium', value: '4'},
                {name: '很大', css: 'large', value: '5'},
                {name: '超大', css: 'x-large', value: '6'},
                //{name: '40px', css: '40px', value: '40px'},
                //{name: '160', css: '160px', value: '160'},
               // {name: '100px', css: '100px', value: '100px'},

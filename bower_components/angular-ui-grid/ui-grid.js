 ...
 */
  ...
  var service = {
     ...
     * @name enableHiding
     * @propertyOf ui.grid.class:GridOptions.columnDef
     * @description (optional) True by default. When set to false, this setting prevents a userinfo from hiding the column
 ...
 */
  ...
  var uiGridColumnMenu = {
    ...
    link: function ($scope, $elm, $attrs, uiGridCtrl) {
      ...
      // Set the menu items for use with the column menu. The userinfo can later add additional items via the watch
      $scope.menuItems = $scope.defaultMenuItems;
    ...
    // *** Show/Hide functions ******
      ...
      self.hideMenu = $scope.hideMenu = function(event, args) {
        if ( $scope.shown ){
           ...
           *   
           * The userinfo may have clicked on the menu again whilst
    ...
    .factory('GridApi', ['$q', '$rootScope', 'gridUtil', 'uiGridConstants', 'GridRow', 'uiGridGridMenuService',
      function ($q, $rootScope, gridUtil, uiGridConstants, GridRow, uiGridGridMenuService) {
        ...
        var GridApi = function GridApi(grid) {
           ...
           * is called, but in that situation the userinfo already knows which row
...
(function () {
   ...
   * userinfo to key data and then tab, arrow, or enter to the cells beside or below.
   *
    ...
    function ($q, uiGridExporterConstants, uiGridSelectionConstants, gridUtil, $compile, $interval, i18nService) {
      ...
      var service = {
        ...
        defaultGridOptions: function (gridOptions) {
           ...
           * @description Don't show the export menu button, implying the userinfo
         ...
         * allowing the userinfo to select export options
...
;          }
         ...
         * and sends that data to the userinfo
...
(function () {
   ...
   * the userinfo sees don't match the column names).
   * 
    ...
    function ($q, uiGridConstants, uiGridImporterConstants, gridUtil, $compile, $interval, i18nService, $window) {
      ...
      var service = {
        ...
        defaultGridOptions: function (gridOptions) {
           ...
           * to false if the userinfo's browser does not support the required fileApi.
           ...
           * logic.  Set this callback function if the headers that your userinfo will provide in their
           ...
           * that the userinfo recognises are in a different language than the field names that
           * ui-grid knows about.
           * 
           ...
           * generally doesn't add rows to the source data array, it is tidier to handle this through a userinfo
           * callback.
           * 
           * <pre>
         ...
         * allowing the userinfo to request import of a file
         ...
         * @name alertError
         * @methodOf ui.grid.importer.service:uiGridImporterService
         * @description Provides an internationalised userinfo alert for the failure,
         * and logs a console message including diagnostic content.
         * Optionally, if the the `gridOptions.importerErrorCallback` routine
         * is defined, then calls that instead, allowing userinfo specified error routines
         * @param {Grid} grid the grid we're importing into
         * @param {array} headerRow the header row that we wish to match against
         * the column definitions
         */
...
(function () {
   ...
   *
   *  # ui.grid.pinning
   * This module provides column pinning to the end userinfo via menu options in the column header
   * <br/>
   * <br/>
   *
  ...
  module.service('uiGridRowEditService', ['$interval', '$q', 'uiGridConstants', 'uiGridRowEditConstants', 'gridUtil', 
    function ($interval, $q, uiGridConstants, uiGridRowEditConstants, gridUtil) {
      ...
      var service = {
          ...
          var publicApi = {
            events: {
              rowEdit: {
                 ...
                 * or last update time/userinfo information).
                 * 
            ...
            methods: {
              rowEdit: {
                 ...
                 * be used where userinfo presses a save button or navigates away from the page
                 * <pre>
         ...
         * and cancels any rowEditSaveTimers if present, as the userinfo is still editing
         ...
         * never triggered by timer (implying that the userinfo will call flushDirtyRows()
         * manually)
         * 
         * @example
